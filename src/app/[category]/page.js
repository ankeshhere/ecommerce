        ...
        <div>
            ...
            <section className="max-w-[1300px] mx-auto">
                ...
                <div className="flex justify-center my-12 flex-row max-w-[1300px] mx-auto gap-4 flex-wrap">
                    <Link href={''} className="border border-primary px-8 font-bold font-heading py-2 rounded-md hover:bg-primary hover:text-white   duration-150 transition-all">Collection 1</Link>
                    <Link href={''} className="border border-primary px-8 font-bold font-heading py-2 rounded-md hover:bg-primary hover:text-white   duration-150 transition-all">Collection 1</Link>
                    <Link href={''} className="border border-primary px-8 font-bold font-heading py-2 rounded-md hover:bg-primary hover:text-white   duration-150 transition-all">Collection 1</Link>
                    <Link href={''} className="border border-primary px-8 font-bold font-heading py-2 rounded-md hover:bg-primary hover:text-white   duration-150 transition-all">Collection 1</Link>
                    <Link href={''} className="border border-primary px-8 font-bold font-heading py-2 rounded-md hover:bg-primary hover:text-white   duration-150 transition-all">Collection 1</Link>
            ...
            <section className="max-w-[1300px] mx-auto my-12">
                <h3 className="text-primary font-heading font-bold text-center text-2xl  mb-4">Collection 2</h3>
                <div className="grid gap-2 p-2 grid-cols-2 sm:grid-cols-2 lg:gap-r lg:grid-cols-5">
                    <Product />
                    <Product />
                    <Product />
