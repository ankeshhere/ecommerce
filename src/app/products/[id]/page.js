        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex flex-wrap -mx-4">
                ...
                <div className="w-full md:w-1/2 px-4">
                    ...
                    <div className="mb-4">
                        {
                            productDetails.fields.inStock ? <span className="text-2xl font-bold mr-2">₹ {formatRupee(productDetails.fields.price)}</span>
                                : <p className="text-2xl font-bold mr-2 text-slate-400">
                                    <span className="line-through">₹ {formatRupee(productDetails.fields.price)}</span>
                                    <span className="pl-4">OUT OF STOCK</span></p> 
                    ...
                    {
                        productDetails.fields.inStock ? <div className="block md:flex space-y-4 md:space-y-0 md:space-x-4 mb-6">
                        ...
                        </div> : <div className="bg-gray-200 flex items-center justify-center p-2 ">
                            <p className="font-bold font-heading text-slate-400">OUT OF STOCK</p>
                        </div>
                    }
